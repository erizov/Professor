...
Authorization is a fundamental algorithm in computer science used to solve specific computational problems efficiently.
...
Authorization is used to solve specific computational problems efficiently. 

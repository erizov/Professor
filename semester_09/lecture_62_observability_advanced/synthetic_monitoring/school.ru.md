...
- **Purpose:** Synthetic Monitoring solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Advanced Graduate Level
- **Key Idea:** Synthetic Monitoring uses [key technique] to [achieve goal].

Synthetic Monitoring is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**SYNTHETIC_MONITORING** = Remember: [key steps]

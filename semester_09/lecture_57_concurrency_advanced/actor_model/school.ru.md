...
Actor Model — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы actor model:
...
4. Как actor model обрабатывает граничные случаи?
5. Какие преимущества и недостатки у actor model?
6. Можно ли улучшить работу actor model?

### Сложные

7. Какова временная сложность actor model?
8. Как actor model работает с большими объёмами данных?
9. Как можно оптимизировать actor model?

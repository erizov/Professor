...
4. Как wait free algorithms обрабатывает граничные случаи?
5. Какие преимущества и недостатки у wait free algorithms?
6. Можно ли улучшить работу wait free algorithms?

### Сложные

7. Какова временная сложность wait free algorithms?
8. Как wait free algorithms работает с большими объёмами данных?
9. Как можно оптимизировать wait free algorithms?

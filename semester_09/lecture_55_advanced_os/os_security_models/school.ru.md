...
4. Как os security models обрабатывает граничные случаи?
5. Какие преимущества и недостатки у os security models?
6. Можно ли улучшить работу os security models?

### Сложные

7. Какова временная сложность os security models?
8. Как os security models работает с большими объёмами данных?
9. Как можно оптимизировать os security models?

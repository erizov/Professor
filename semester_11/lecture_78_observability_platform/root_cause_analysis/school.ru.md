...
- **Purpose:** Root Cause Analysis solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Advanced Graduate Level
- **Key Idea:** Root Cause Analysis uses [key technique] to [achieve goal].

Root Cause Analysis is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**ROOT_CAUSE_ANALYSIS** = Remember: [key steps]

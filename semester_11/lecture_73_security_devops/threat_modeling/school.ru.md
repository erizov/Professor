...
4. Как threat modeling обрабатывает граничные случаи?
5. Какие преимущества и недостатки у threat modeling?
6. Можно ли улучшить работу threat modeling?

### Сложные

7. Какова временная сложность threat modeling?
8. Как threat modeling работает с большими объёмами данных?
9. Как можно оптимизировать threat modeling?

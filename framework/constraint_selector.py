...
class AlgorithmSelector:
    ...
    def select_ml_algorithm(
        ...
        for name, props in cls.ML_ALGORITHMS.items():
            ...
            score = cls._score_ml_algorithm(
                props, constraints, problem_type
            )
            candidates.append((name, props, score))
    ...
    def _generate_reasoning(
        ...
        reasons.append(
            f"Time complexity: {props['time']}, "
            f"Space complexity: {props['space']}"
        )

...
10. Design a system that uses Unit Of Work to solve a production issue
...
✓ **CORRECT**: Unit Of Work has specific use cases and trade-offs; choose algorithms based on requirements

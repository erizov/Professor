...
Strategy is a fundamental algorithm in computer science used to solve specific computational problems efficiently.
...
Strategy is used to solve specific computational problems efficiently. 

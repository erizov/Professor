...
Proxy is a fundamental algorithm in computer science used to solve specific computational problems efficiently.
...
Proxy is used to solve specific computational problems efficiently. 

...
# -*- coding: utf-8 -*-
"""
Unit tests for Open Addressing.
"""
...
class TestOpenaddressing(AlgorithmTestCase):
    """Test Open Addressing implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_01.lecture_08_hash_tables.open_addressing.algorithm import open_addressing

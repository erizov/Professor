...
4. Как collision resolution: chaining обрабатывает граничные случаи?
5. Какие преимущества и недостатки у collision resolution: chaining?
6. Можно ли улучшить работу collision resolution: chaining?

### Сложные

7. Какова временная сложность collision resolution: chaining?
8. Как collision resolution: chaining работает с большими объёмами данных?
9. Как можно оптимизировать collision resolution: chaining?

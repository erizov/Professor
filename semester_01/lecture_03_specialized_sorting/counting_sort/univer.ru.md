...
Counting Sort часто используется в сочетании с:
...
**Exercise 1 (Easy):**
**Exercise 1 (Easy):**
Trace through the Counting Sort algorithm with a small example. Analyze time and space complexity.

**Exercise 2 (Medium):**
Implement the Counting Sort algorithm with proper error handling and edge case coverage.

**Exercise 3 (Hard):**
Optimize the Counting Sort algorithm or design a variant for a specific use case. Analyze trade-offs.

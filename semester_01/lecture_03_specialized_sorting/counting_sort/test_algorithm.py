...
class TestCountingsort(AlgorithmTestCase):
    """Test Counting Sort implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_01.lecture_03_specialized_sorting.counting_sort.algorithm import counting_sort
        self.algorithm = counting_sort

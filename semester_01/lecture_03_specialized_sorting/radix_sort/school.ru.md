...
**Exercise 1 (Easy):**
**Exercise 1 (Easy):**
Trace through the Radix Sort algorithm with a small example (3-5 elements). Write down each step.

**Exercise 2 (Medium):**
Implement the Radix Sort algorithm in your preferred programming language. Test it with different inputs.

**Exercise 3 (Hard):**
Apply the Radix Sort algorithm to solve a real-world problem. Explain why this algorithm is suitable.

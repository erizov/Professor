...
Bucket Сортировка упорядочивает элементы списка по возрастанию или убыванию, используя специальную стратегию сравнения и перестановки элементов.
...
Рассмотрим пример работы bucket сортировка:

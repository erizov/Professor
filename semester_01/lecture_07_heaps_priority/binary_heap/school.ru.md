...
4. Как binary heap обрабатывает граничные случаи?
5. Какие преимущества и недостатки у binary heap?
6. Можно ли улучшить работу binary heap?

### Сложные

7. Какова временная сложность binary heap?
8. Как binary heap работает с большими объёмами данных?
9. Как можно оптимизировать binary heap?

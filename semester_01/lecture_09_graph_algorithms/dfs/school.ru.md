...
Depth-First Поиск просматривает элементы списка один за другим, сравнивая каждый с искомым значением, пока не найдёт нужный элемент.
...
Рассмотрим пример работы depth-first поиск:

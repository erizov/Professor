...
4. Как b-tree обрабатывает граничные случаи?
5. Какие преимущества и недостатки у b-tree?
6. Можно ли улучшить работу b-tree?

### Сложные

7. Какова временная сложность b-tree?
8. Как b-tree работает с большими объёмами данных?
9. Как можно оптимизировать b-tree?

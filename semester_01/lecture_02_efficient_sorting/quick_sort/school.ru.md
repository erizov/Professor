...
Быстрая сортировка использует стратегию 'разделяй и властвуй'. Алгоритм выбирает опорный элемент, разделяет список на части (меньше и больше опорного) и рекурсивно сортирует каждую часть.
...
Рассмотрим пример работы быстрая сортировка:

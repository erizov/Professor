...
- **Purpose:** Selection Sort arranges elements in a specific order (ascending or descending) by comparing and rearranging elements.
...
**SELECTION_SORT** = Remember: Understand the problem → Apply Sorting principles → Process systematically → Verify results
...
- Selection Sort is often used with [related algorithms]

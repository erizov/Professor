...
Этот алгоритм относится к категории **Sorting** и использует swapping elements для достижения своих целей.
...
Selection Sort часто используется в сочетании с:

...
4. Как yolo object detection обрабатывает граничные случаи?
5. Какие преимущества и недостатки у yolo object detection?
6. Можно ли улучшить работу yolo object detection?

### Сложные

7. Какова временная сложность yolo object detection?
8. Как yolo object detection работает с большими объёмами данных?
9. Как можно оптимизировать yolo object detection?

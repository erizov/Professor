...
4. Как single shot detector обрабатывает граничные случаи?
5. Какие преимущества и недостатки у single shot detector?
6. Можно ли улучшить работу single shot detector?

### Сложные

7. Какова временная сложность single shot detector?
8. Как single shot detector работает с большими объёмами данных?
9. Как можно оптимизировать single shot detector?

...
4. Как u-net segmentation обрабатывает граничные случаи?
5. Какие преимущества и недостатки у u-net segmentation?
6. Можно ли улучшить работу u-net segmentation?

### Сложные

7. Какова временная сложность u-net segmentation?
8. Как u-net segmentation работает с большими объёмами данных?
9. Как можно оптимизировать u-net segmentation?

...
4. Как fully convolutional networks обрабатывает граничные случаи?
5. Какие преимущества и недостатки у fully convolutional networks?
6. Можно ли улучшить работу fully convolutional networks?

### Сложные

7. Какова временная сложность fully convolutional networks?
8. Как fully convolutional networks работает с большими объёмами данных?
9. Как можно оптимизировать fully convolutional networks?

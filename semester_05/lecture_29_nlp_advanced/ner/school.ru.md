...
4. Как named entity recognition обрабатывает граничные случаи?
5. Какие преимущества и недостатки у named entity recognition?
6. Можно ли улучшить работу named entity recognition?

### Сложные

7. Какова временная сложность named entity recognition?
8. Как named entity recognition работает с большими объёмами данных?
9. Как можно оптимизировать named entity recognition?

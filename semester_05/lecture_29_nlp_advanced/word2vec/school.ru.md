...
4. Как word2vec обрабатывает граничные случаи?
5. Какие преимущества и недостатки у word2vec?
6. Можно ли улучшить работу word2vec?

### Сложные

7. Какова временная сложность word2vec?
8. Как word2vec работает с большими объёмами данных?
9. Как можно оптимизировать word2vec?

...
4. Как glove embeddings обрабатывает граничные случаи?
5. Какие преимущества и недостатки у glove embeddings?
6. Можно ли улучшить работу glove embeddings?

### Сложные

7. Какова временная сложность glove embeddings?
8. Как glove embeddings работает с большими объёмами данных?
9. Как можно оптимизировать glove embeddings?

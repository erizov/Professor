...
4. Как transformer architecture обрабатывает граничные случаи?
5. Какие преимущества и недостатки у transformer architecture?
6. Можно ли улучшить работу transformer architecture?

### Сложные

7. Какова временная сложность transformer architecture?
8. Как transformer architecture работает с большими объёмами данных?
9. Как можно оптимизировать transformer architecture?

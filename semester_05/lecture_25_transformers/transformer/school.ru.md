...
Transformer Architecture — это алгоритм для решения конкретной задачи в области компьютерных наук.
...
Рассмотрим конкретный пример работы transformer architecture:
...
1. Что делает алгоритм transformer architecture?
2. В каких ситуациях используется transformer architecture?
3. Какие данные нужны для работы алгоритма?

### Средние

1. Как transformer architecture обрабатывает граничные случаи?
2. Какие преимущества и недостатки у transformer architecture?
3. Можно ли улучшить работу transformer architecture?

### Сложные

1. Какова временная сложность transformer architecture?
2. Как transformer architecture работает с большими объёмами данных?
3. Как можно оптимизировать transformer architecture?

## Практические задания

### Уровень 1 (Лёгкий)

Выполни простую операцию с алгоритмом transformer architecture.
Используй небольшой набор данных (3-5 элементов) и выведи результат.

### Уровень 2 (Средний)

Примени алгоритм transformer architecture к более сложному набору данных.
Проанализируй результат, объясни каждый шаг работы алгоритма.

### Уровень 3 (Продвинутый)

Напиши реализацию алгоритма transformer architecture на языке программирования.

...
1. Как bert language model обрабатывает граничные случаи?
2. Какие преимущества и недостатки у bert language model?
3. Можно ли улучшить работу bert language model?

### Сложные

1. Какова временная сложность bert language model?
2. Как bert language model работает с большими объёмами данных?
3. Как можно оптимизировать bert language model?

...
4. Как policy gradient обрабатывает граничные случаи?
5. Какие преимущества и недостатки у policy gradient?
6. Можно ли улучшить работу policy gradient?

### Сложные

7. Какова временная сложность policy gradient?
8. Как policy gradient работает с большими объёмами данных?
9. Как можно оптимизировать policy gradient?

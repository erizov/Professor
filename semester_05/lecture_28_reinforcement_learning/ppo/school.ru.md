...
1. Как proximal policy optimization обрабатывает граничные случаи?
2. Какие преимущества и недостатки у proximal policy optimization?
3. Можно ли улучшить работу proximal policy optimization?

### Сложные

1. Какова временная сложность proximal policy optimization?
2. Как proximal policy optimization работает с большими объёмами данных?
3. Как можно оптимизировать proximal policy optimization?

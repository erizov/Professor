...
Q-Learning — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы q-learning:
...
2. В каких ситуациях используется q-learning?
3. Какие данные нужны для работы алгоритма?

### Средние

4. Как q-learning обрабатывает граничные случаи?
5. Какие преимущества и недостатки у q-learning?
6. Можно ли улучшить работу q-learning?

### Сложные

7. Какова временная сложность q-learning?
8. Как q-learning работает с большими объёмами данных?
9. Как можно оптимизировать q-learning?
...
Выполни простую операцию с алгоритмом q-learning. 
Используй небольшой набор данных (3-5 элементов) и выведи результат.

### Уровень 2 (Средний)

Примени алгоритм q-learning к более сложному набору данных. 
Проанализируй результат, объясни каждый шаг работы алгоритма.

### Уровень 3 (Продвинутый)

Напиши реализацию алгоритма q-learning на языке программирования. 

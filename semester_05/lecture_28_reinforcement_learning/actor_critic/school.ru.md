...
Actor-Critic — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы actor-critic:
...
4. Как actor-critic обрабатывает граничные случаи?
5. Какие преимущества и недостатки у actor-critic?
6. Можно ли улучшить работу actor-critic?

### Сложные

7. Какова временная сложность actor-critic?
8. Как actor-critic работает с большими объёмами данных?
9. Как можно оптимизировать actor-critic?

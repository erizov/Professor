...
4. Как deep q-network обрабатывает граничные случаи?
5. Какие преимущества и недостатки у deep q-network?
6. Можно ли улучшить работу deep q-network?

### Сложные

7. Какова временная сложность deep q-network?
8. Как deep q-network работает с большими объёмами данных?
9. Как можно оптимизировать deep q-network?

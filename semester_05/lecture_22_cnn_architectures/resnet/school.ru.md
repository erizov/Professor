...
4. Как resnet architecture обрабатывает граничные случаи?
5. Какие преимущества и недостатки у resnet architecture?
6. Можно ли улучшить работу resnet architecture?

### Сложные

7. Какова временная сложность resnet architecture?
8. Как resnet architecture работает с большими объёмами данных?
9. Как можно оптимизировать resnet architecture?

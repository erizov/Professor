...
4. Как vgg network обрабатывает граничные случаи?
5. Какие преимущества и недостатки у vgg network?
6. Можно ли улучшить работу vgg network?

### Сложные

7. Какова временная сложность vgg network?
8. Как vgg network работает с большими объёмами данных?
9. Как можно оптимизировать vgg network?

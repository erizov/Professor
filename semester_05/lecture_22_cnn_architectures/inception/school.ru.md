...
Inception Network — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы inception network:
...
1. Что делает алгоритм inception network?
2. В каких ситуациях используется inception network?
3. Какие данные нужны для работы алгоритма?

### Средние

4. Как inception network обрабатывает граничные случаи?
5. Какие преимущества и недостатки у inception network?
6. Можно ли улучшить работу inception network?

### Сложные

7. Какова временная сложность inception network?
8. Как inception network работает с большими объёмами данных?
9. Как можно оптимизировать inception network?
...
Выполни простую операцию с алгоритмом inception network. 
Используй небольшой набор данных (3-5 элементов) и выведи результат.

### Уровень 2 (Средний)

Примени алгоритм inception network к более сложному набору данных. 
Проанализируй результат, объясни каждый шаг работы алгоритма.

### Уровень 3 (Продвинутый)

Напиши реализацию алгоритма inception network на языке программирования. 

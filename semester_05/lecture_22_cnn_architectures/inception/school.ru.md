...
1. Как inception network обрабатывает граничные случаи?
2. Какие преимущества и недостатки у inception network?
3. Можно ли улучшить работу inception network?

### Сложные

1. Какова временная сложность inception network?
2. Как inception network работает с большими объёмами данных?
3. Как можно оптимизировать inception network?

...
- **Purpose:** Prophet solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Time Series
- **Key Idea:** Prophet uses [key technique] to [achieve goal].

Prophet is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**PROPHET** = Remember: [key steps]

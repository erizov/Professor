...
4. Как fine-tuning pre-trained models обрабатывает граничные случаи?
5. Какие преимущества и недостатки у fine-tuning pre-trained models?
6. Можно ли улучшить работу fine-tuning pre-trained models?

### Сложные

7. Какова временная сложность fine-tuning pre-trained models?
8. Как fine-tuning pre-trained models работает с большими объёмами данных?
9. Как можно оптимизировать fine-tuning pre-trained models?

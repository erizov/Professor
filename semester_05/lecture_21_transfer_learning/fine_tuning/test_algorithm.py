...
class TestFinetuning(AlgorithmTestCase):
    """Test Fine Tuning implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_05.lecture_21_transfer_learning.fine_tuning.algorithm import fine_tuning

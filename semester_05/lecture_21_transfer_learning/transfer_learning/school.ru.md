...
1. Как transfer learning обрабатывает граничные случаи?
2. Какие преимущества и недостатки у transfer learning?
3. Можно ли улучшить работу transfer learning?

### Сложные

1. Какова временная сложность transfer learning?
2. Как transfer learning работает с большими объёмами данных?
3. Как можно оптимизировать transfer learning?

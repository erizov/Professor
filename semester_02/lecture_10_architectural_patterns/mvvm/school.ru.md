...
4. Как model-view-viewmodel обрабатывает граничные случаи?
5. Какие преимущества и недостатки у model-view-viewmodel?
6. Можно ли улучшить работу model-view-viewmodel?

### Сложные

7. Какова временная сложность model-view-viewmodel?
8. Как model-view-viewmodel работает с большими объёмами данных?
9. Как можно оптимизировать model-view-viewmodel?

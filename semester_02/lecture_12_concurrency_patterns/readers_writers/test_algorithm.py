...
# -*- coding: utf-8 -*-
"""
Unit tests for Readers Writers.
"""
...
class TestReaderswriters(AlgorithmTestCase):
    """Test Readers Writers implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_02.lecture_12_concurrency_patterns.readers_writers.algorithm import readers_writers

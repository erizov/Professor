...
4. Как lecture 12 concurrency patterns обрабатывает граничные случаи?
5. Какие преимущества и недостатки у lecture 12 concurrency patterns?
6. Можно ли улучшить работу lecture 12 concurrency patterns?

### Сложные

7. Какова временная сложность lecture 12 concurrency patterns?
8. Как lecture 12 concurrency patterns работает с большими объёмами данных?
9. Как можно оптимизировать lecture 12 concurrency patterns?

...
class TestComposite(AlgorithmTestCase):
    """Test Composite implementation."""

    def setUp(self):
        """Set up test fixtures."""
        from semester_02.lecture_08_structural_patterns.composite.algorithm import Composite

        self.algorithm = Composite

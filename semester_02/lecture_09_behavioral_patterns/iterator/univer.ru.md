...
- **Purpose:** Iterator: The algorithm works by > **Note**: Mermaid diagrams are rendered automatically on GitHub. For local viewing, use a Mermaid-compatible Markdown viewer.
- **Complexity:** O(n)
...
Iterator: The algorithm works by > **Note**: Mermaid diagrams are rendered automatically on GitHub. For local viewing, use a Mermaid-compatible Markdown viewer.
...
**ITERATOR** = Remember the key steps: step 1, step 2, step 3
...
Iterator часто используется в сочетании с:

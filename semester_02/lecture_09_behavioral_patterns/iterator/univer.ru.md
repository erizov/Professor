...
- **Purpose:** Iterator solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Behavioral Pattern
- **Key Idea:** Iterator uses [key technique] to [achieve goal].

Iterator is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**ITERATOR** = Remember: [key steps]

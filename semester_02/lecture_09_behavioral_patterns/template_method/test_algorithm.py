...
# -*- coding: utf-8 -*-
"""
Unit tests for Template Method.
"""
...
class TestTemplatemethod(AlgorithmTestCase):
    """Test Template Method implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_02.lecture_09_behavioral_patterns.template_method.algorithm import template_method

...
Encode: encode optimization problem as quantum Hamiltonian.
Initialize: prepare initial quantum state (superposition).
Apply: apply alternating unitaries (problem and mixer Hamiltonians).
Measure: measure quantum state to get candidate solution.
Evaluate: evaluate solution quality using cost function.
Optimize: use classical optimizer to adjust parameters.
Iterate: repeat quantum evolution and classical optimization.
Converge: converge to optimal parameters and solution.
Extract: extract best solution from quantum measurements.
Validate: validate solution quality and feasibility.

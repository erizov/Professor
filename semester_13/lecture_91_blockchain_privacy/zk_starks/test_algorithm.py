...
class TestZkstarks(AlgorithmTestCase):
    """Test Zk Starks implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_13.lecture_91_blockchain_privacy.zk_starks.algorithm import zk_starks
        self.algorithm = zk_starks

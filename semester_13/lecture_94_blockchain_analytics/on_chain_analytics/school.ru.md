...
4. Как on chain analytics обрабатывает граничные случаи?
5. Какие преимущества и недостатки у on chain analytics?
6. Можно ли улучшить работу on chain analytics?

### Сложные

7. Какова временная сложность on chain analytics?
8. Как on chain analytics работает с большими объёмами данных?
9. Как можно оптимизировать on chain analytics?

...
4. Как multi chain apps обрабатывает граничные случаи?
5. Какие преимущества и недостатки у multi chain apps?
6. Можно ли улучшить работу multi chain apps?

### Сложные

7. Какова временная сложность multi chain apps?
8. Как multi chain apps работает с большими объёмами данных?
9. Как можно оптимизировать multi chain apps?

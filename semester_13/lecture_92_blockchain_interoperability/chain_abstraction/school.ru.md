...
4. Как chain abstraction обрабатывает граничные случаи?
5. Какие преимущества и недостатки у chain abstraction?
6. Можно ли улучшить работу chain abstraction?

### Сложные

7. Какова временная сложность chain abstraction?
8. Как chain abstraction работает с большими объёмами данных?
9. Как можно оптимизировать chain abstraction?

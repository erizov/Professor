...
- **Purpose:** Tendermint solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Advanced Graduate Level
- **Key Idea:** Tendermint uses [key technique] to [achieve goal].

Tendermint is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**TENDERMINT** = Remember: [key steps]

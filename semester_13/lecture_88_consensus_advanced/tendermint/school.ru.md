...
4. Как tendermint обрабатывает граничные случаи?
5. Какие преимущества и недостатки у tendermint?
6. Можно ли улучшить работу tendermint?

### Сложные

7. Какова временная сложность tendermint?
8. Как tendermint работает с большими объёмами данных?
9. Как можно оптимизировать tendermint?

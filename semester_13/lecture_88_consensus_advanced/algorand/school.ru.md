...
4. Как algorand обрабатывает граничные случаи?
5. Какие преимущества и недостатки у algorand?
6. Можно ли улучшить работу algorand?

### Сложные

7. Какова временная сложность algorand?
8. Как algorand работает с большими объёмами данных?
9. Как можно оптимизировать algorand?

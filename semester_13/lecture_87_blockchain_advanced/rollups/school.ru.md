...
- **Purpose:** Rollups solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Advanced Graduate Level
- **Key Idea:** Rollups uses [key technique] to [achieve goal].

Rollups is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**ROLLUPS** = Remember: [key steps]

...
1. Как plasma обрабатывает граничные случаи?
2. Какие преимущества и недостатки у plasma?
3. Можно ли улучшить работу plasma?

### Сложные

1. Какова временная сложность plasma?
2. Как plasma работает с большими объёмами данных?
3. Как можно оптимизировать plasma?

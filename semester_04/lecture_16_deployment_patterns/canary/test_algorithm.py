...
class TestCanary(AlgorithmTestCase):
    """Test Canary implementation."""

    def setUp(self):
        """Set up test fixtures."""
        from semester_04.lecture_16_deployment_patterns.canary.algorithm import Canary

        self.algorithm = Canary

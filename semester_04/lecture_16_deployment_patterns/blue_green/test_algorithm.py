...
class TestBluegreen(AlgorithmTestCase):
    """Test Blue Green implementation."""

    def setUp(self):
        """Set up test fixtures."""
        from semester_04.lecture_16_deployment_patterns.blue_green.algorithm import BlueGreen

        self.algorithm = BlueGreen

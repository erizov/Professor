...
4. Как bcrypt password hashing обрабатывает граничные случаи?
5. Какие преимущества и недостатки у bcrypt password hashing?
6. Можно ли улучшить работу bcrypt password hashing?

### Сложные

7. Какова временная сложность bcrypt password hashing?
8. Как bcrypt password hashing работает с большими объёмами данных?
9. Как можно оптимизировать bcrypt password hashing?

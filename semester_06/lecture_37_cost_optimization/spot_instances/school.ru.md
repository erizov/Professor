...
4. Как spot instance training обрабатывает граничные случаи?
5. Какие преимущества и недостатки у spot instance training?
6. Можно ли улучшить работу spot instance training?

### Сложные

7. Какова временная сложность spot instance training?
8. Как spot instance training работает с большими объёмами данных?
9. Как можно оптимизировать spot instance training?

...
class TestBluegreenml(AlgorithmTestCase):
    """Test Blue Green Ml implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_06.lecture_35_deployment_patterns.blue_green_ml.algorithm import blue_green_ml
        self.algorithm = blue_green_ml

...
1. Как federated learning обрабатывает граничные случаи?
2. Какие преимущества и недостатки у federated learning?
3. Можно ли улучшить работу federated learning?

### Сложные

1. Какова временная сложность federated learning?
2. Как federated learning работает с большими объёмами данных?
3. Как можно оптимизировать federated learning?

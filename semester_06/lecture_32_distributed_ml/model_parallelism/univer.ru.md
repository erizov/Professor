...
**Временная сложность:** O(n*layers/workers)
...
**Пространственная сложность:** O(model/workers)
...
Model Parallelism используется в:
...
Model Parallelism часто используется в сочетании с:

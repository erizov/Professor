...
4. Как parameter server обрабатывает граничные случаи?
5. Какие преимущества и недостатки у parameter server?
6. Можно ли улучшить работу parameter server?

### Сложные

7. Какова временная сложность parameter server?
8. Как parameter server работает с большими объёмами данных?
9. Как можно оптимизировать parameter server?

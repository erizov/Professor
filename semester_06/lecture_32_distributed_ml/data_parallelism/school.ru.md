...
4. Как данных parallelism обрабатывает граничные случаи?
5. Какие преимущества и недостатки у данных parallelism?
6. Можно ли улучшить работу данных parallelism?

### Сложные

7. Какова временная сложность данных parallelism?
8. Как данных parallelism работает с большими объёмами данных?
9. Как можно оптимизировать данных parallelism?

...
**Временная сложность:** O(n/workers)
...
**Пространственная сложность:** O(model + n/workers)
...
Data Parallelism используется в:
...
Data Parallelism часто используется в сочетании с:

...
Model Pruning — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы model pruning:
...
4. Как model pruning обрабатывает граничные случаи?
5. Какие преимущества и недостатки у model pruning?
6. Можно ли улучшить работу model pruning?

### Сложные

7. Какова временная сложность model pruning?
8. Как model pruning работает с большими объёмами данных?
9. Как можно оптимизировать model pruning?

...
4. Как model quantization обрабатывает граничные случаи?
5. Какие преимущества и недостатки у model quantization?
6. Можно ли улучшить работу model quantization?

### Сложные

7. Какова временная сложность model quantization?
8. Как model quantization работает с большими объёмами данных?
9. Как можно оптимизировать model quantization?

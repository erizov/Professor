...
4. Как model caching обрабатывает граничные случаи?
5. Какие преимущества и недостатки у model caching?
6. Можно ли улучшить работу model caching?

### Сложные

7. Какова временная сложность model caching?
8. Как model caching работает с большими объёмами данных?
9. Как можно оптимизировать model caching?

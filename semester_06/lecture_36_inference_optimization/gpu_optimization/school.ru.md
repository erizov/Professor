...
4. Как gpu optimization обрабатывает граничные случаи?
5. Какие преимущества и недостатки у gpu optimization?
6. Можно ли улучшить работу gpu optimization?

### Сложные

7. Какова временная сложность gpu optimization?
8. Как gpu optimization работает с большими объёмами данных?
9. Как можно оптимизировать gpu optimization?

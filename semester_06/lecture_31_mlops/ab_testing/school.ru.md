...
1. Как a/b testing for ml обрабатывает граничные случаи?
2. Какие преимущества и недостатки у a/b testing for ml?
3. Можно ли улучшить работу a/b testing for ml?

### Сложные

1. Какова временная сложность a/b testing for ml?
2. Как a/b testing for ml работает с большими объёмами данных?
3. Как можно оптимизировать a/b testing for ml?

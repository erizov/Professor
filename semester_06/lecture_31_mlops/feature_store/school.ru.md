...
1. Как feature store pattern обрабатывает граничные случаи?
2. Какие преимущества и недостатки у feature store pattern?
3. Можно ли улучшить работу feature store pattern?

### Сложные

1. Какова временная сложность feature store pattern?
2. Как feature store pattern работает с большими объёмами данных?
3. Как можно оптимизировать feature store pattern?

...
class TestEfficientnet(AlgorithmTestCase):
    """Test Efficientnet implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_5.lecture_22_cnn_architectures.efficientnet.algorithm import efficientnet

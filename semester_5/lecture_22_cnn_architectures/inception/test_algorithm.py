...
class TestInception(AlgorithmTestCase):
    """Test Inception implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_5.lecture_22_cnn_architectures.inception.algorithm import inception

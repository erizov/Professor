...
class TestMaskrcnn(AlgorithmTestCase):
    """Test Mask Rcnn implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_5.lecture_24_segmentation.mask_rcnn.algorithm import mask_rcnn

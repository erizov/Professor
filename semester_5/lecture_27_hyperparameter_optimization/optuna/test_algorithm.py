...
class TestOptuna(AlgorithmTestCase):
    """Test Optuna implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_5.lecture_27_hyperparameter_optimization.optuna.algorithm import optuna

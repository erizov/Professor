...
def create_readme_from_template(algorithm_name: str, description: str = None) -> str:
        ...
        for lecture_dir in semester_dir.iterdir():
            ...
            for algo_dir in lecture_dir.iterdir():
                ...
                if readme_path.exists():
                    ...
                    if (
                        "[describe use case]" in content
                        or "[Use case 1]" in content
                        or "[Algorithm description to be added" in content
                    ):
...
def update_readme_with_web_info(
    readme_path: Path, algorithm_name: str, web_description: str = None
) -> bool:

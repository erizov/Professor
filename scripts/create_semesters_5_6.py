...
SEMESTERS_5_6 = {
    "semester_05": {
        ...
        "lecture_27_hyperparameter_optimization": [
            {
                ...
                "time": "O(n*combinations)",
                "space": "O(n)",
            },
            {
                "folder": "random_search",
                "name": "Random Search",
                "category": "Optimization",
                "time": "O(n*iterations)",
                "space": "O(n)",
        ...
        "lecture_30_time_series": [
            ...
            {
                "folder": "lstm_timeseries",
                "name": "LSTM for Time Series",
                "category": "Time Series",
                "time": "O(n*timesteps*d)",
                "space": "O(timesteps*d)",
            },
            {
                "folder": "prophet",
    ...
    "semester_06": {
        ...
        "lecture_32_distributed_ml": [
            ...
            {
                "folder": "model_parallelism",
                "name": "Model Parallelism",
                "category": "Distributed ML",
                "time": "O(n*layers/workers)",
                "space": "O(model/workers)",
            },
            {
                "folder": "parameter_server",
                "name": "Parameter Server",
                "category": "Distributed ML",
                "time": "O(sync_overhead)",
                "space": "O(params)",
            },
            {
                "folder": "allreduce",
                "name": "AllReduce Algorithm",
                "category": "Distributed ML",
                "time": "O(log(workers))",
                "space": "O(params)",
            },
            {
                "folder": "federated_learning",
                "name": "Federated Learning",
                "category": "Distributed ML",
                "time": "O(rounds*clients)",
                "space": "O(model)",
            },
        ],
        ...
        "lecture_36_inference_optimization": [
            ...
            {
                "folder": "gpu_optimization",
                "name": "GPU Optimization",
                "category": "Inference",
                "time": "O(n/parallelism)",
                "space": "O(vram)",
            },
        ],
        "lecture_37_cost_optimization": [
            {
                "folder": "spot_instances",
                "name": "Spot Instance Training",
            ...
            {
                "folder": "autoscaling",
                "name": "Auto-scaling for ML",
                "category": "Cost Optimization",
                "time": "O(dynamic)",
                "space": "O(dynamic)",
            },
            {
                "folder": "serverless_ml",
                "name": "Serverless ML",
                "category": "Cost Optimization",
                "time": "O(requests)",
                "space": "O(0)",
            ...
            {
                "folder": "cost_analysis",
                "name": "ML Cost Analysis",
                "category": "Cost Optimization",
                "time": "O(resources)",
                "space": "O(logs)",
            },
...
def create_algorithm(semester: str, lecture: str, algo_info: dict) -> None:
    ...
    metadata = {
        ...
        "complexity": {"time": algo_info["time"], "space": algo_info["space"]},
        "resources": {
            "memory_requirement": "varies",
            "cpu_intensive": (
                True if "Deep Learning" in algo_info["category"] else False
            ),
            "gpu_recommended": (
                True
                if "Deep Learning" in algo_info["category"]
                or "ML" in algo_info["category"]
                else False
            ),

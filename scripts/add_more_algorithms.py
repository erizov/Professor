...
ADDITIONAL_ALGORITHMS = {
    ...
    "semester_02": {
        ...
        "lecture_12_concurrency_patterns": [
            ...
            {
                "folder": "readers_writers",
                "name": "Readers-Writers Lock",
                "category": "Concurrency",
                "time": "O(1)",
                "space": "O(1)",
            },

...
def create_readme_section(algorithm_name: str, 
                         description_data: Optional[Dict[str, str]]) -> str:
    """Create README section with algorithm description."""
    if description_data:
        wiki_name = description_data.get('wikipedia', 
...
def update_readme_file(readme_path: Path, algorithm_name: str) -> bool:
    ...
    # Insert description
    new_lines = lines[:insert_index] + [''] + new_section.split('\n') + lines[insert_index:]

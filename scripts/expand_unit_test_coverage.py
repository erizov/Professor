...
def get_algorithm_category(algorithm_path: Path, algorithm_name: str) -> str:
    ...
    if "tree" in path_str or "tree" in algo_name_lower or "bst" in algo_name_lower:
        ...
        or "knapsack" in algo_name_lower
        or "fibonacci" in algo_name_lower
    ):
        return "dp"
    elif "pattern" in path_str or "design" in path_str:
        return "pattern"
    elif (
        "string" in path_str or "kmp" in algo_name_lower or "pattern" in algo_name_lower
    ):
        return "string"
    else:
        return "general"

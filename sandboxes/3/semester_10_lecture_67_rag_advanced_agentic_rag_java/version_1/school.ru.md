...
4. Как version 1 обрабатывает граничные случаи?
5. Какие преимущества и недостатки у version 1?
6. Можно ли улучшить работу version 1?

### Сложные

7. Какова временная сложность version 1?
8. Как version 1 работает с большими объёмами данных?
9. Как можно оптимизировать version 1?

...
class TestFractionalknapsack(AlgorithmTestCase):
    """Test Fractional Knapsack implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_3.lecture_15_greedy_algorithms.fractional_knapsack.algorithm import fractional_knapsack

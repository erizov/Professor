...
Bellman Ford is a fundamental algorithm in computer science used to solve specific computational problems efficiently.
...
Bellman–Ford algorithm is used to solve specific computational problems efficiently. 

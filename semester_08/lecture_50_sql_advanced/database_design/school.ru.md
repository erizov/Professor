...
4. Как database design обрабатывает граничные случаи?
5. Какие преимущества и недостатки у database design?
6. Можно ли улучшить работу database design?

### Сложные

7. Какова временная сложность database design?
8. Как database design работает с большими объёмами данных?
9. Как можно оптимизировать database design?

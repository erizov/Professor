...
- **Purpose:** Database Design solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Advanced SQL
- **Key Idea:** Database Design uses [key technique] to [achieve goal].

Database Design is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**DATABASE_DESIGN** = Remember: [key steps]

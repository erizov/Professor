...
Replication — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы replication:
...
4. Как replication обрабатывает граничные случаи?
5. Какие преимущества и недостатки у replication?
6. Можно ли улучшить работу replication?

### Сложные

7. Какова временная сложность replication?
8. Как replication работает с большими объёмами данных?
9. Как можно оптимизировать replication?

...
4. Как граф databases обрабатывает граничные случаи?
5. Какие преимущества и недостатки у граф databases?
6. Можно ли улучшить работу граф databases?

### Сложные

7. Какова временная сложность граф databases?
8. Как граф databases работает с большими объёмами данных?
9. Как можно оптимизировать граф databases?

...
class TestNosqlquerying(AlgorithmTestCase):
    """Test Nosql Querying implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_08.lecture_51_nosql_fundamentals.nosql_querying.algorithm import nosql_querying

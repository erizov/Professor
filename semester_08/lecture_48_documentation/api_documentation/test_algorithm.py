...
class TestApidocumentation(AlgorithmTestCase):
    """Test Api Documentation implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_08.lecture_48_documentation.api_documentation.algorithm import api_documentation
        self.algorithm = api_documentation

...
1. Как user guides обрабатывает граничные случаи?
2. Какие преимущества и недостатки у user guides?
3. Можно ли улучшить работу user guides?

### Сложные

1. Какова временная сложность user guides?
2. Как user guides работает с большими объёмами данных?
3. Как можно оптимизировать user guides?

...
Dimensional Modeling — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы dimensional modeling:
...
4. Как dimensional modeling обрабатывает граничные случаи?
5. Какие преимущества и недостатки у dimensional modeling?
6. Можно ли улучшить работу dimensional modeling?

### Сложные

7. Какова временная сложность dimensional modeling?
8. Как dimensional modeling работает с большими объёмами данных?
9. Как можно оптимизировать dimensional modeling?

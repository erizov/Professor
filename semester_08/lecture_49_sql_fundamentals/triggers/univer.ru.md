...
- **Purpose:** Triggers solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** SQL Database Fundamentals
- **Key Idea:** Triggers uses [key technique] to [achieve goal].

Triggers is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**TRIGGERS** = Remember: [key steps]

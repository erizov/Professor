...
4. Как triggers обрабатывает граничные случаи?
5. Какие преимущества и недостатки у triggers?
6. Можно ли улучшить работу triggers?

### Сложные

7. Какова временная сложность triggers?
8. Как triggers работает с большими объёмами данных?
9. Как можно оптимизировать triggers?

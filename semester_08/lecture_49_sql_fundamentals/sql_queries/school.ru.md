...
4. Как sql queries обрабатывает граничные случаи?
5. Какие преимущества и недостатки у sql queries?
6. Можно ли улучшить работу sql queries?

### Сложные

7. Какова временная сложность sql queries?
8. Как sql queries работает с большими объёмами данных?
9. Как можно оптимизировать sql queries?

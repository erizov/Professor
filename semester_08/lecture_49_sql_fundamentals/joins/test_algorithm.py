...
class TestJoins(AlgorithmTestCase):
    """Test Joins implementation."""

    def setUp(self):
        """Set up test fixtures."""
        from semester_08.lecture_49_sql_fundamentals.joins.algorithm import JoinOperations

        self.algorithm = JoinOperations

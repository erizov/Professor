...
Joins — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы joins:
...
4. Как joins обрабатывает граничные случаи?
5. Какие преимущества и недостатки у joins?
6. Можно ли улучшить работу joins?

### Сложные

7. Какова временная сложность joins?
8. Как joins работает с большими объёмами данных?
9. Как можно оптимизировать joins?

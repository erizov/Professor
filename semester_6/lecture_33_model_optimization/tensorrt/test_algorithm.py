...
class TestTensorrt(AlgorithmTestCase):
    """Test Tensorrt implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_6.lecture_33_model_optimization.tensorrt.algorithm import tensorrt

...
class TestDatadrift(AlgorithmTestCase):
    """Test Data Drift implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_6.lecture_31_mlops.data_drift.algorithm import data_drift

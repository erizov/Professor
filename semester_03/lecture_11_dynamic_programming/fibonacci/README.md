...
4. **Inputs & Outputs**  
   - Input: Integer n ≥ 0.  
   - Output: The nth Fibonacci number (0-indexed).

5. **Step-by-step description (5–10 lines max)**  
1. Handle base cases fib(0)=0, fib(1)=1.
2. Initialize array dp of size n+1.
3. Iterate i from 2..n: dp[i]=dp[i-1]+dp[i-2].
4. Optionally reduce to two variables for constant space.
5. Return dp[n].

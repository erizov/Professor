...
- **Purpose:** Activity Selection solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Greedy Algorithm
- **Key Idea:** Activity Selection uses [key technique] to [achieve goal].

Activity Selection is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**ACTIVITY_SELECTION** = Remember: [key steps]

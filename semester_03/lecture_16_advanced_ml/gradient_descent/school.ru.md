...
4. Как gradient descent обрабатывает граничные случаи?
5. Какие преимущества и недостатки у gradient descent?
6. Можно ли улучшить работу gradient descent?

### Сложные

7. Какова временная сложность gradient descent?
8. Как gradient descent работает с большими объёмами данных?
9. Как можно оптимизировать gradient descent?

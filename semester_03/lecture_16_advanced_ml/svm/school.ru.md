...
1. Как support vector machine обрабатывает граничные случаи?
2. Какие преимущества и недостатки у support vector machine?
3. Можно ли улучшить работу support vector machine?

### Сложные

1. Какова временная сложность support vector machine?
2. Как support vector machine работает с большими объёмами данных?
3. Как можно оптимизировать support vector machine?

...
- **Purpose:** K Means solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Algorithms
- **Key Idea:** K Means uses [key technique] to [achieve goal].

K Means is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**K_MEANS** = Remember: [key steps]

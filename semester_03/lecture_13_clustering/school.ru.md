...
4. Как lecture 13 clustering обрабатывает граничные случаи?
5. Какие преимущества и недостатки у lecture 13 clustering?
6. Можно ли улучшить работу lecture 13 clustering?

### Сложные

7. Какова временная сложность lecture 13 clustering?
8. Как lecture 13 clustering работает с большими объёмами данных?
9. Как можно оптимизировать lecture 13 clustering?

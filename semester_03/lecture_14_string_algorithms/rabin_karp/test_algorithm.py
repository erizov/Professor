...
class TestRabinkarp(AlgorithmTestCase):
    """Test Rabin Karp implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_03.lecture_14_string_algorithms.rabin_karp.algorithm import rabin_karp

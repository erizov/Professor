...
4. Как linear regression обрабатывает граничные случаи?
5. Какие преимущества и недостатки у linear regression?
6. Можно ли улучшить работу linear regression?

### Сложные

7. Какова временная сложность linear regression?
8. Как linear regression работает с большими объёмами данных?
9. Как можно оптимизировать linear regression?

...
4. Как naive bayes обрабатывает граничные случаи?
5. Какие преимущества и недостатки у naive bayes?
6. Можно ли улучшить работу naive bayes?

### Сложные

7. Какова временная сложность naive bayes?
8. Как naive bayes работает с большими объёмами данных?
9. Как можно оптимизировать naive bayes?

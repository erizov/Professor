...
- **Purpose:** Kmeans processes data according to Machine Learning principles to achieve specific computational goals.
...
**KMEANS** = Remember: Understand the problem → Apply Machine Learning principles → Process systematically → Verify results
...
- Kmeans is used in [specific domain]

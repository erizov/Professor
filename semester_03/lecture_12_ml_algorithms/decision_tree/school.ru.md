...
4. Как decision дерево обрабатывает граничные случаи?
5. Какие преимущества и недостатки у decision дерево?
6. Можно ли улучшить работу decision дерево?

### Сложные

7. Какова временная сложность decision дерево?
8. Как decision дерево работает с большими объёмами данных?
9. Как можно оптимизировать decision дерево?

...
4. Как logistic regression обрабатывает граничные случаи?
5. Какие преимущества и недостатки у logistic regression?
6. Можно ли улучшить работу logistic regression?

### Сложные

7. Какова временная сложность logistic regression?
8. Как logistic regression работает с большими объёмами данных?
9. Как можно оптимизировать logistic regression?

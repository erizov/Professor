...
4. Как nosql consistency models обрабатывает граничные случаи?
5. Какие преимущества и недостатки у nosql consistency models?
6. Можно ли улучшить работу nosql consistency models?

### Сложные

7. Какова временная сложность nosql consistency models?
8. Как nosql consistency models работает с большими объёмами данных?
9. Как можно оптимизировать nosql consistency models?

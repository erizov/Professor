...
4. Как граф analytics обрабатывает граничные случаи?
5. Какие преимущества и недостатки у граф analytics?
6. Можно ли улучшить работу граф analytics?

### Сложные

7. Какова временная сложность граф analytics?
8. Как граф analytics работает с большими объёмами данных?
9. Как можно оптимизировать граф analytics?

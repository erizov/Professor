...
1. Как index strategies обрабатывает граничные случаи?
2. Какие преимущества и недостатки у index strategies?
3. Можно ли улучшить работу index strategies?

### Сложные

1. Какова временная сложность index strategies?
2. Как index strategies работает с большими объёмами данных?
3. Как можно оптимизировать index strategies?

...
- **Purpose:** Downsampling solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Advanced Graduate Level
- **Key Idea:** Downsampling uses [key technique] to [achieve goal].

Downsampling is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**DOWNSAMPLING** = Remember: [key steps]

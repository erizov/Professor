...
1. Как prompt engineering обрабатывает граничные случаи?
2. Какие преимущества и недостатки у prompt engineering?
3. Можно ли улучшить работу prompt engineering?

### Сложные

1. Какова временная сложность prompt engineering?
2. Как prompt engineering работает с большими объёмами данных?
3. Как можно оптимизировать prompt engineering?

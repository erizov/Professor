...
1. Как blockchain scalability обрабатывает граничные случаи?
2. Какие преимущества и недостатки у blockchain scalability?
3. Можно ли улучшить работу blockchain scalability?

### Сложные

1. Какова временная сложность blockchain scalability?
2. Как blockchain scalability работает с большими объёмами данных?
3. Как можно оптимизировать blockchain scalability?

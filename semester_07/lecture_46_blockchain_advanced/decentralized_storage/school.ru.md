...
1. Как decentralized storage обрабатывает граничные случаи?
2. Какие преимущества и недостатки у decentralized storage?
3. Можно ли улучшить работу decentralized storage?

### Сложные

1. Какова временная сложность decentralized storage?
2. Как decentralized storage работает с большими объёмами данных?
3. Как можно оптимизировать decentralized storage?

...
Proof Of Stake — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы proof of stake:
...
4. Как proof of stake обрабатывает граничные случаи?
5. Какие преимущества и недостатки у proof of stake?
6. Можно ли улучшить работу proof of stake?

### Сложные

7. Какова временная сложность proof of stake?
8. Как proof of stake работает с большими объёмами данных?
9. Как можно оптимизировать proof of stake?

...
4. Как merkle trees обрабатывает граничные случаи?
5. Какие преимущества и недостатки у merkle trees?
6. Можно ли улучшить работу merkle trees?

### Сложные

7. Какова временная сложность merkle trees?
8. Как merkle trees работает с большими объёмами данных?
9. Как можно оптимизировать merkle trees?

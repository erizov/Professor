...
4. Как smart contracts обрабатывает граничные случаи?
5. Какие преимущества и недостатки у smart contracts?
6. Можно ли улучшить работу smart contracts?

### Сложные

7. Какова временная сложность smart contracts?
8. Как smart contracts работает с большими объёмами данных?
9. Как можно оптимизировать smart contracts?

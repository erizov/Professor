...
- **Purpose:** Chain Of Thought solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Advanced LLM Techniques
- **Key Idea:** Chain Of Thought uses [key technique] to [achieve goal].

Chain Of Thought is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**CHAIN_OF_THOUGHT** = Remember: [key steps]

...
Explainability — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы explainability:
...
4. Как explainability обрабатывает граничные случаи?
5. Какие преимущества и недостатки у explainability?
6. Можно ли улучшить работу explainability?

### Сложные

7. Какова временная сложность explainability?
8. Как explainability работает с большими объёмами данных?
9. Как можно оптимизировать explainability?

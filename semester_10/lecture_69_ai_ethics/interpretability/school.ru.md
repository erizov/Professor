...
4. Как interpretability обрабатывает граничные случаи?
5. Какие преимущества и недостатки у interpretability?
6. Можно ли улучшить работу interpretability?

### Сложные

7. Какова временная сложность interpretability?
8. Как interpretability работает с большими объёмами данных?
9. Как можно оптимизировать interpretability?

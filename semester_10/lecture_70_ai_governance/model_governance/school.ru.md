...
1. Как model governance обрабатывает граничные случаи?
2. Какие преимущества и недостатки у model governance?
3. Можно ли улучшить работу model governance?

### Сложные

1. Какова временная сложность model governance?
2. Как model governance работает с большими объёмами данных?
3. Как можно оптимизировать model governance?

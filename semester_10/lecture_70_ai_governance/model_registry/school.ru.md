...
4. Как model registry обрабатывает граничные случаи?
5. Какие преимущества и недостатки у model registry?
6. Можно ли улучшить работу model registry?

### Сложные

7. Какова временная сложность model registry?
8. Как model registry работает с большими объёмами данных?
9. Как можно оптимизировать model registry?

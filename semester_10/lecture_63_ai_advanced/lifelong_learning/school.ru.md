...
4. Как lifelong learning обрабатывает граничные случаи?
5. Какие преимущества и недостатки у lifelong learning?
6. Можно ли улучшить работу lifelong learning?

### Сложные

7. Какова временная сложность lifelong learning?
8. Как lifelong learning работает с большими объёмами данных?
9. Как можно оптимизировать lifelong learning?

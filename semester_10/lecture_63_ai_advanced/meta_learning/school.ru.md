...
1. Как meta learning обрабатывает граничные случаи?
2. Какие преимущества и недостатки у meta learning?
3. Можно ли улучшить работу meta learning?

### Сложные

1. Какова временная сложность meta learning?
2. Как meta learning работает с большими объёмами данных?
3. Как можно оптимизировать meta learning?

...
4. Как zero shot learning обрабатывает граничные случаи?
5. Какие преимущества и недостатки у zero shot learning?
6. Можно ли улучшить работу zero shot learning?

### Сложные

7. Какова временная сложность zero shot learning?
8. Как zero shot learning работает с большими объёмами данных?
9. Как можно оптимизировать zero shot learning?

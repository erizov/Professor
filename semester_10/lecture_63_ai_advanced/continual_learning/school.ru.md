...
4. Как continual learning обрабатывает граничные случаи?
5. Какие преимущества и недостатки у continual learning?
6. Можно ли улучшить работу continual learning?

### Сложные

7. Какова временная сложность continual learning?
8. Как continual learning работает с большими объёмами данных?
9. Как можно оптимизировать continual learning?

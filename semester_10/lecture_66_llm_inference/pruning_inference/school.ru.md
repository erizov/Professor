...
4. Как pruning inference обрабатывает граничные случаи?
5. Какие преимущества и недостатки у pruning inference?
6. Можно ли улучшить работу pruning inference?

### Сложные

7. Какова временная сложность pruning inference?
8. Как pruning inference работает с большими объёмами данных?
9. Как можно оптимизировать pruning inference?

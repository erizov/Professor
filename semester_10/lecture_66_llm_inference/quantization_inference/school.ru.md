...
4. Как quantization inference обрабатывает граничные случаи?
5. Какие преимущества и недостатки у quantization inference?
6. Можно ли улучшить работу quantization inference?

### Сложные

7. Какова временная сложность quantization inference?
8. Как quantization inference работает с большими объёмами данных?
9. Как можно оптимизировать quantization inference?

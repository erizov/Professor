...
4. Как batch inference обрабатывает граничные случаи?
5. Какие преимущества и недостатки у batch inference?
6. Можно ли улучшить работу batch inference?

### Сложные

7. Какова временная сложность batch inference?
8. Как batch inference работает с большими объёмами данных?
9. Как можно оптимизировать batch inference?

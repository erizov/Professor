...
class TestMultihoprag(AlgorithmTestCase):
    """Test Multi Hop Rag implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_10.lecture_67_rag_advanced.multi_hop_rag.algorithm import multi_hop_rag

...
4. Как gradient checkpointing обрабатывает граничные случаи?
5. Какие преимущества и недостатки у gradient checkpointing?
6. Можно ли улучшить работу gradient checkpointing?

### Сложные

7. Какова временная сложность gradient checkpointing?
8. Как gradient checkpointing работает с большими объёмами данных?
9. Как можно оптимизировать gradient checkpointing?

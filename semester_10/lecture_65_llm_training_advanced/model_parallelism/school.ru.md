...
4. Как model parallelism обрабатывает граничные случаи?
5. Какие преимущества и недостатки у model parallelism?
6. Можно ли улучшить работу model parallelism?

### Сложные

7. Какова временная сложность model parallelism?
8. Как model parallelism работает с большими объёмами данных?
9. Как можно оптимизировать model parallelism?

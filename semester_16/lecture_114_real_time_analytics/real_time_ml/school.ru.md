...
1. Как real time ml обрабатывает граничные случаи?
2. Какие преимущества и недостатки у real time ml?
3. Можно ли улучшить работу real time ml?

### Сложные

1. Какова временная сложность real time ml?
2. Как real time ml работает с большими объёмами данных?
3. Как можно оптимизировать real time ml?

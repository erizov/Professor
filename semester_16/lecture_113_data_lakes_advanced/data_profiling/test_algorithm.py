...
class TestDataprofiling(AlgorithmTestCase):
    """Test Data Profiling implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_16.lecture_113_data_lakes_advanced.data_profiling.algorithm import data_profiling
        self.algorithm = data_profiling

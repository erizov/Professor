...
4. Как a b testing ml обрабатывает граничные случаи?
5. Какие преимущества и недостатки у a b testing ml?
6. Можно ли улучшить работу a b testing ml?

### Сложные

7. Какова временная сложность a b testing ml?
8. Как a b testing ml работает с большими объёмами данных?
9. Как можно оптимизировать a b testing ml?

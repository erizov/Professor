...
Star Schema — это алгоритм для решения конкретной задачи в области компьютерных наук. 
...
Рассмотрим конкретный пример работы star schema:
...
4. Как star schema обрабатывает граничные случаи?
5. Какие преимущества и недостатки у star schema?
6. Можно ли улучшить работу star schema?

### Сложные

7. Какова временная сложность star schema?
8. Как star schema работает с большими объёмами данных?
9. Как можно оптимизировать star schema?

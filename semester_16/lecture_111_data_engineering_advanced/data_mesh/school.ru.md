...
4. Как данных mesh обрабатывает граничные случаи?
5. Какие преимущества и недостатки у данных mesh?
6. Можно ли улучшить работу данных mesh?

### Сложные

7. Какова временная сложность данных mesh?
8. Как данных mesh работает с большими объёмами данных?
9. Как можно оптимизировать данных mesh?

...
```
Data Versioning Step-by-Step Execution:
...
- [Python Implementation](/code/semester_16/lecture_116_data_ops/data_versioning/algorithm.py)
- [Java Implementation](/code/semester_16/lecture_116_data_ops/data_versioning/Algorithm.java)
- [Python Tests](/code/semester_16/lecture_116_data_ops/data_versioning/test_algorithm.py)

What problem does it solve? (1 sentence)  
Implements data versioning algorithm.

Intuition (plain-language explanation)  
Data Versioning is a fundamental algorithm in computer science.
...
Tiny example (hand-simulated)  
   Example: Data Versioning applied to sample data.

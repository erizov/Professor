...
class TestApiexplorer(AlgorithmTestCase):
    """Test Api Explorer implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_14.lecture_101_developer_experience.api_explorer.algorithm import api_explorer

...
4. Как natural language docs обрабатывает граничные случаи?
5. Какие преимущества и недостатки у natural language docs?
6. Можно ли улучшить работу natural language docs?

### Сложные

7. Какова временная сложность natural language docs?
8. Как natural language docs работает с большими объёмами данных?
9. Как можно оптимизировать natural language docs?

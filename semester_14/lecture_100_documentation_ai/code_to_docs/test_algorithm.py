...
class TestCodetodocs(AlgorithmTestCase):
    """Test Code To Docs implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_14.lecture_100_documentation_ai.code_to_docs.algorithm import code_to_docs
        self.algorithm = code_to_docs

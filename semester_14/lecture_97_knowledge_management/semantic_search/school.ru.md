...
Semantic Поиск — это алгоритм поиска определённого элемента в структуре данных.
...
Рассмотрим конкретный пример работы semantic поиск:
...
Выполни простую операцию с алгоритмом semantic поиск.
Используй небольшой набор данных (3-5 элементов) и выведи результат.

### Уровень 2 (Средний)

Примени алгоритм semantic поиск к более сложному набору данных.
Проанализируй результат, объясни каждый шаг работы алгоритма.

### Уровень 3 (Продвинутый)

Напиши реализацию алгоритма semantic поиск на языке программирования.

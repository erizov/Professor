...
- **Purpose:** Postmortem Automation solves [algorithm purpose] by [key approach].
- **Complexity:** Varies
- **Category:** Advanced Graduate Level
- **Key Idea:** Postmortem Automation uses [key technique] to [achieve goal].

Postmortem Automation is an algorithm that [brief description of what it does and why it's important].

The algorithm works by [key steps in the process].

**POSTMORTEM_AUTOMATION** = Remember: [key steps]

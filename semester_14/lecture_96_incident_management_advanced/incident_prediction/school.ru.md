...
4. Как incident prediction обрабатывает граничные случаи?
5. Какие преимущества и недостатки у incident prediction?
6. Можно ли улучшить работу incident prediction?

### Сложные

7. Какова временная сложность incident prediction?
8. Как incident prediction работает с большими объёмами данных?
9. Как можно оптимизировать incident prediction?

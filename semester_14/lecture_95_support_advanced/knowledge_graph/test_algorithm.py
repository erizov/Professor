...
class TestKnowledgegraph(AlgorithmTestCase):
    """Test Knowledge Graph implementation."""
    
    def setUp(self):
        """Set up test fixtures."""
        from semester_14.lecture_95_support_advanced.knowledge_graph.algorithm import knowledge_graph
        self.algorithm = knowledge_graph

...
4. Как doc as code обрабатывает граничные случаи?
5. Какие преимущества и недостатки у doc as code?
6. Можно ли улучшить работу doc as code?

### Сложные

7. Какова временная сложность doc as code?
8. Как doc as code работает с большими объёмами данных?
9. Как можно оптимизировать doc as code?
